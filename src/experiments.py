...
VERSION_SPECS: Dict[str, VersionSpec] = {
    ...
    "loop_final_mean_pool": VersionSpec(
        name="loop_final_mean_pool",
        family="loop",
        loss_type="final_loop",
        description="Mean-pool memory loop retriever supervised only at the final loop.",
        eval_all_loops=True,
        plot_kind="curve",
        color="#1f77b4",
    ...
    "loop_matryoshka_mean_pool": VersionSpec(
        name="loop_matryoshka_mean_pool",
        family="loop",
        loss_type="loopwise",
        description="Mean-pool memory loop retriever supervised at every loop.",
        eval_all_loops=True,
        plot_kind="curve",
        color="#d62728",
        loop_memory_mode="mean_pool",
